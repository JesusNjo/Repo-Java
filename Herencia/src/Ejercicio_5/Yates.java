...
public class Yates extends Barcos {
    ...
    public Yates(int cv, int camarotes, int matricula, int eslora, int anioF, String nombre, long documentoC, LocalDate fechaA, LocalDate fechaD, int amarre, Barcos nombreBarco) {
