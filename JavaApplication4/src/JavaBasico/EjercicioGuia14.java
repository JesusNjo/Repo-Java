...
public class EjercicioGuia14 {
    ...
    public static void main(String[] args) {
        ...
        switch(moneda){
            case 1: System.out.println("La cantidad euros que desea convertir :");
            System.out.println(Euros(Euros,n2));
            break;
            case 2: System.out.println("La cantidad de dolares que desea convertir es: ");
            System.out.println(Dolares(dolar,n2));
            break;
            case 3: System.out.println("La cantidad de yenes que desea convertir es: ");
